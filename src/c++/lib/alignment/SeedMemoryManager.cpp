...
template class SeedMemoryManager<oligo::BasicKmerType<28> >;
template class SeedMemoryManager<oligo::BasicKmerType<30> >;
template class SeedMemoryManager<oligo::KmerType>;
template class SeedMemoryManager<oligo::BasicKmerType<34> >;
template class SeedMemoryManager<oligo::BasicKmerType<36> >;
