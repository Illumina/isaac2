...
template class ExactMaskMatcher<oligo::BasicKmerType<28> >;
template class ExactMaskMatcher<oligo::BasicKmerType<30> >;
template class ExactMaskMatcher<oligo::KmerType>;
template class ExactMaskMatcher<oligo::BasicKmerType<34> >;
template class ExactMaskMatcher<oligo::BasicKmerType<36> >;
