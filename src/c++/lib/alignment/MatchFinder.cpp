...
template class MatchFinder<oligo::BasicKmerType<28> >;
template class MatchFinder<oligo::BasicKmerType<30> >;
template class MatchFinder<oligo::KmerType>;
template class MatchFinder<oligo::BasicKmerType<34> >;
template class MatchFinder<oligo::BasicKmerType<36> >;
