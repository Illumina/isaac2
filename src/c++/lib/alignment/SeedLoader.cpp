...
static typename Container::iterator uninitializedIterator()
{
    static Container blah;
    return blah.begin();
}
...
ParallelSeedLoader<ReaderT, KmerT>::ParallelSeedLoader(
    ...
    , threadDestinations_(inputLoadersMax, std::vector<typename std::vector<Seed<KmerT> >::iterator>(sortedReferenceMetadataList.size(), uninitializedIterator<std::vector<Seed<KmerT> > >()))
    , threadCycleDestinations_(inputLoadersMax, std::vector<typename std::vector<Seed<KmerT> >::iterator>(sortedReferenceMetadataList.size(), uninitializedIterator<std::vector<Seed<KmerT> > >()))
    , threads_(threads)
                    ...
                    cycleSeedsBegin->getLength() <= cycle)
                {
                    ...
                    BOOST_FOREACH(const std::vector<std::vector<unsigned> > &reference, BaseT::referenceTileReadFragmentCounts_)
                    {
                        ...
                        thisThreadDestinationBegins[referenceIndex] +=
                            reference.at(tileIndex).at(cycleSeedsBegin->getReadIndex());
                    }
                    ++cycleSeedsBegin;
                }
...
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclBgzfTileReader, isaac::oligo::BasicKmerType<28> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclBgzfTileReader, isaac::oligo::BasicKmerType<30> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclBgzfTileReader, isaac::oligo::KmerType>;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclBgzfTileReader, isaac::oligo::BasicKmerType<34> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclBgzfTileReader, isaac::oligo::BasicKmerType<36> >;
...
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclReader, isaac::oligo::BasicKmerType<28> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclReader, isaac::oligo::BasicKmerType<30> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclReader, isaac::oligo::KmerType>;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclReader, isaac::oligo::BasicKmerType<34> >;
template class isaac::alignment::ParallelSeedLoader<isaac::rta::BclReader, isaac::oligo::BasicKmerType<36> >;
