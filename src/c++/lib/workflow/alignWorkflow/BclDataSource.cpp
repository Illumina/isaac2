...
template class BclSeedSource<oligo::BasicKmerType<28> >;
template class BclSeedSource<oligo::BasicKmerType<30> >;
template class BclSeedSource<oligo::KmerType>;
template class BclSeedSource<oligo::BasicKmerType<34> >;
template class BclSeedSource<oligo::BasicKmerType<36> >;
