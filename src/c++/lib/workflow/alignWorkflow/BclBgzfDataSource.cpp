...
template class BclBgzfSeedSource<oligo::BasicKmerType<28> >;
template class BclBgzfSeedSource<oligo::BasicKmerType<30> >;
template class BclBgzfSeedSource<oligo::KmerType>;
template class BclBgzfSeedSource<oligo::BasicKmerType<34> >;
template class BclBgzfSeedSource<oligo::BasicKmerType<36> >;
