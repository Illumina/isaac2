...
public:
    ...
    unsigned long getBinSize() const {return binSize_;}
...
private:
     ...
     */
    static const unsigned long BINS_PER_GENOME = 1024 * 100;
    unsigned long binSize_;
     ...
     */
    template <class Archive> friend void serialize(Archive &ar, MatchDistribution &md, const unsigned int version);
};
