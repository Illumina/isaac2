...
if (NOT Boost_FOUND)
    ...
    if ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
        list (APPEND INSTALL_OPTIONS "-d")
    endif ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
    
    execute_process(COMMAND "/bin/bash"
                            "${CMAKE_SOURCE_DIR}/cmake/bootstrap/installBoost.sh"
                            "${BOOST_REDIST_DIR}" "${CMAKE_CURRENT_BINARY_DIR}/bootstrap"
                            "${CMAKE_PARALLEL}"
                            "${CMAKE_CXX_COMPILER}" "${INSTALL_OPTIONS}"
